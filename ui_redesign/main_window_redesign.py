...
class Ui_HSMainWindow(object):
    def setupUi(self, HSMainWindow):
        ...
        HSMainWindow.setMinimumSize(QtCore.QSize(1600, 900))
        font = QtGui.QFont()
...
"}")
        ...
        self.messagesBtn.setEnabled(False)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
...
"background-color: rgb(255, 255, 255);")
        ...
        self.gridLayout_4.addWidget(self.catalogTable, 4, 0, 1, 11)
...
"}")
        ...
        self.gridLayout_4.addItem(spacerItem1, 3, 9, 1, 1)
...
"}")
        ...
        self.gridLayout_6.addItem(spacerItem3, 11, 0, 1, 1)
...
"}")
        ...
        self.menubar.setGeometry(QtCore.QRect(0, 0, 1738, 21))
